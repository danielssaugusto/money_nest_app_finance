...
Sistema moderno de gestão financeira pessoal construído com **Spring Boot** e **Vanilla JavaScript**.

## 🚀 Início Rápido
1.  Configure seu banco PostgreSQL em `application.properties`.
2.  Execute `AppFinanceApplication.java`.
3.  Acesse `http://localhost:8081`.

## 📚 Documentação Detalhada
Para entender a arquitetura, funções do código e detalhes técnicos, consulte o arquivo:
